...
export const ChatPage: React.FC = () => {
    ...
    const conversations: Conversation[] = useMemo(() => {
        return rooms.map(room => {
            ...
            const mentor: Mentor = {
                ...
                roleCode: room.mentorType || "AS", // Default or derive from room.mentorType if available
                roleTitle: "Mentor",
                isOnline: false, // Need realtime presence for this
                lastSeen: "1 phút trước",
                description: "Chuyên gia tư vấn...",
                achievements: ["5 năm kinh nghiệm", "Mentor xuất sắc"]
            };
    ...
    const messages: Message[] = useMemo(() => {
        return rawMessages.map(msg => ({
            ...
            content: msg.content || (msg.attachments?.length ? "[File đính kèm]" : ""),
