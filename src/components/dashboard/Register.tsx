...
export default function Register({onRegister}: RegisterProps) {
    ...
    const handleRegister = (e: React.FormEvent) => {
        ...
        onRegister(registerData.email, registerData.name, registerData.role)
    }
                    ...
                    <form onSubmit={handleRegister} className="space-y-5">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-1">
                                {registerData.role === 'user' && 'Học viên: Truy cập các khóa học và tài liệu'}
                                {registerData.role === 'mentor' && 'Mentor: Hỗ trợ và quản lý học viên'}
                                {registerData.role === 'admin' && 'Admin: Quản trị toàn bộ hệ thống'}
                            </p>
                        </div>
