            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="academic" className="space-y-4 mt-6">
                ...
                <div className="bg-primary/10 border-l-4 border-primary p-6 rounded-lg transition-colors duration-300">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-bold text-foreground text-lg">
                      CHỨNG CHỈ NGOẠI NGỮ (IELTS, DET, JLPT,HSK...)
                    </h3>
                    <Button
                      size="sm"
                      variant="outline"
                ...
                <div className="bg-primary/10 border-l-4 border-primary p-6 rounded-lg transition-colors duration-300">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-bold text-foreground text-lg">
                      ĐIỂM TỪNG MÔN HỌC (Subject Scores)
                    </h3>
                    <Button
                      size="sm"
                      variant="outline"
              ...
              <TabsContent value="profile" className="space-y-4 mt-6">
                ...
                <div className="bg-primary/10 border-l-4 border-primary p-6 rounded-lg transition-colors duration-300">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-bold text-foreground text-lg">
                      CÁC GIẢI THƯỞNG KHÁC (Nghệ thuật, thể thao,...)
                    </h3>
                    <Button
                      size="sm"
                      variant="outline"
              ...
              <TabsContent value="parents" className="space-y-4 mt-6">
                <div className="bg-primary/10 border-l-4 border-primary p-6 rounded-lg transition-colors duration-300">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-bold text-foreground text-lg">
                      THÔNG TIN LIÊN LẠC CỦA PHỤ HUYNH/NGƯỜI GIÁM HỘ
                    </h3>
                    <Button
                      size="sm"
                      variant="outline"
