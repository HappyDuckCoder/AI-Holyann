  ...
  return (
    ...
    >
      ...
      <p className="text-muted-foreground text-sm mb-5">
        Các lần xem gợi ý trước đây — bấm <strong className="text-foreground">Xem</strong> để hiển thị chi tiết.
      </p>
          ...
          >
            ...
            {onSelectItem && (
              <button
                ...
                className="ml-auto inline-flex items-center gap-1 rounded-lg px-3 py-1.5 text-xs font-semibold text-white transition-all duration-200 hover:opacity-95 group-hover:gap-2"
                style={{
