  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-4">
        ...
        {isCompleted && (
          <div className="flex items-center gap-1.5 px-2.5 py-1 bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-300 rounded-full text-xs font-semibold">
