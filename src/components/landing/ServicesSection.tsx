    ...
    return (
        <section id="dich-vu" className="py-20 bg-white">
            <div className="container mx-auto px-4">
                <SectionHeading subtitle="Giải Pháp Của Chúng Tôi" dark={true}>Dịch Vụ Cung Cấp</SectionHeading>
                ...
                <div className="max-w-4xl mx-auto">
                    {activeServiceTab === 'comprehensive' ? (
                        ...
                        >
                            ...
                            <div className={`p-8 text-white ${BRAND_COLORS.primaryGradient}`}>
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                    <div>
                                        <h3 className="text-2xl md:text-3xl font-bold mb-2">Gói Tư Vấn Toàn Diện
                                            1-1</h3>
                                        <p className="opacity-90 text-sm md:text-base font-medium">
                                            Đồng hành 1-1 trong vòng 1 năm (8 - 16 tháng) cho 1 kỳ tuyển sinh.
                                        </p>
                                    </div>
                                ...
                                <div
                                    className="mt-4 inline-block px-3 py-1 bg-white/20 rounded-full text-xs font-semibold uppercase tracking-wider">
                                    Áp dụng cho: Vùng A (Mỹ), Vùng B (Châu Á), Vùng C (Âu, Úc, Canada)
                                </div>
                            </div>
                            ...
                            <div className="p-8 bg-slate-50/50">
                                <div className="space-y-8 relative">
                                    ...
                                    <div
                                        className="absolute left-[15px] top-4 bottom-4 w-0.5 bg-slate-200 hidden md:block"></div>

                                    {comprehensivePhases.map((phase, index) => (
                                        <div key={index} className="relative md:pl-10">
                                            {/* Number/Dot Badge */}
                                            <div
                                                className="hidden md:flex absolute left-0 top-0 w-8 h-8 rounded-full bg-white border-4 border-blue-100 items-center justify-center font-bold text-blue-600 text-sm z-10 shadow-sm">
                                                {index + 1}
                                            </div>

                                            <h4 className="text-lg font-bold text-slate-800 mb-4 flex items-center gap-2">
                                                <span
                                                    className="md:hidden bg-blue-100 text-blue-600 text-xs px-2 py-1 rounded-full">GĐ {index + 1}</span>
                                                {phase.title}
                                            </h4>
                            ...
                            <div className="p-8 border-t border-slate-100 bg-white text-center">
                                <p className="text-slate-500 text-sm mb-6 italic">
                                    * Chi phí linh hoạt dựa trên số lượng trường (3 - 20 trường) và vùng địa lý.
                                </p>
                                <button
                        ...
                        >
                            <div
                                className="p-8 bg-slate-900 text-white flex justify-between items-center flex-wrap gap-4">
                                <div>
                                    <h3 className="text-2xl font-bold mb-2">Gói Lẻ Sửa Luận Chính</h3>
                                    <p className="opacity-80">Dành cho bạn đã có hồ sơ, cần tối ưu bài luận.</p>
                                </div>
                                <div className="text-3xl font-bold text-amber-400">16.500.000 VNĐ</div>
                            </div>
                            <div className="p-8">
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div>
                                        <h4 className="font-bold text-slate-800 mb-4 flex items-center gap-2"><Lightbulb
                                            className="w-5 h-5 text-amber-500"/> Khám Phá & Ý Tưởng</h4>
                                        <ul className="space-y-3 text-sm text-slate-600">
                                            <li className="flex gap-2"><CheckCircle2 size={16}
                                                                                     className="text-blue-500 mt-1"/> Làm
                                                bài test cá nhân (Sở thích, tính cách).
                                            </li>
                                            <li className="flex gap-2"><CheckCircle2 size={16}
                                                                                     className="text-blue-500 mt-1"/> Cố
                                                vấn 1-1 phân tích và chọn hướng viết.
                                            </li>
                                            <li className="flex gap-2"><CheckCircle2 size={16}
                                                                                     className="text-blue-500 mt-1"/> Gợi
                                                ý 5 ý tưởng bài luận độc đáo.
                                            </li>
                                        </ul>
                                    </div>
                                    <div>
                                        <h4 className="font-bold text-slate-800 mb-4 flex items-center gap-2">
                                            <CheckCircle2 className="w-5 h-5 text-blue-500"/> Hoàn Thiện</h4>
                                        <ul className="space-y-3 text-sm text-slate-600">
                                            <li className="flex gap-2"><CheckCircle2 size={16}
                                                                                     className="text-blue-500 mt-1"/> Lên
                                                dàn ý chi tiết cho ý tưởng tốt nhất.
                                            </li>
                                            <li className="flex gap-2"><CheckCircle2 size={16}
                                            ...
                                            <li className="flex gap-2"><CheckCircle2 size={16}
                                                                                     className="text-blue-500 mt-1"/> Đảm
                                                bảo dấu ấn cá nhân "Future by Design".
                                            </li>
                                        </ul>
                                    </div>
                                </div>
