...
export default function AdminNavbar() {
  ...
  // Menu chính – chỉ quản lý người dùng
  const navItems = [
  ...
  // Menu trong dropdown user: Xếp hạng trường, Feedback, Cài đặt, Chế độ tối
  const userMenuItems = [
    {
      name: "Xếp hạng trường",
      href: "/admin/university-rankings",
      icon: Award,
    },
              ...
              <div className="mt-2 border-t border-white/10 pt-2">
                {userMenuItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <Icon className="h-4 w-4 opacity-70" /> {item.name}
                    </Link>
                  );
                })}
                <ThemeToggle
