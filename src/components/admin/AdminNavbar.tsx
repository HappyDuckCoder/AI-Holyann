...
export default function AdminNavbar() {
    ...
    const navItems = [
        ...
        { name: 'Trao đổi', href: '/admin/chat', icon: MessageCircle },
        { name: 'Cài đặt', href: '/admin/settings', icon: Settings },
    ]

    return (
        <header className="bg-gradient-to-r from-primary to-secondary text-primary-foreground px-4 sm:px-6 md:px-8 py-4 shadow-md flex justify-between items-center sticky top-0 z-50 transition-colors duration-300">
                ...
                {isAuthenticated ? (
                    <div className="flex items-center gap-2 sm:gap-3 pl-1 sm:pl-2">
                        <div className="text-right hidden xl:block">
                            <p className="text-xs text-white font-sans">ADMIN</p>
                        ...
                        {isAuthenticated && (
                            <div className="mt-2 pt-2 border-t border-primary-foreground/20">
                                <div className="px-4 py-2 flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs text-primary-foreground/70 font-sans">ADMIN</p>
