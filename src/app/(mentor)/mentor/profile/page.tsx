...
export default function MentorProfilePage() {
  return (
    <div className="min-h-[calc(100vh-theme(spacing.14))] bg-background">
      <div className="container max-w-screen-7xl px-4 py-6 sm:px-6 md:px-8 md:py-8">
        <header className="mb-8 border-b border-border pb-6">
          <h1 className="text-2xl font-heading font-bold tracking-tight text-foreground sm:text-3xl">
            Hồ sơ chuyên môn
          </h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Cập nhật thông tin cá nhân và chuyên môn của bạn. Hồ sơ đầy đủ giúp
            học viên tin tưởng và kết nối tốt hơn.
          </p>
        </header>
