    ...
    try {
        ...
        const response = {
            ...
            studentInfo: {
                ...
                target_faculty_name: user.students?.target_faculty_name || null,
                target_university_id: user.students?.target_university_id ?? null,
                target_university_name: user.students?.target_university_name || null,
                target_set_at: user.students?.target_set_at?.toISOString() ?? null,
            },
