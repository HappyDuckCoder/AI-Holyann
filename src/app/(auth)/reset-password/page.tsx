              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    required
                    disabled={loading || !!emailFromQuery || step === 2}
                  />
                </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full px-4 py-3 pr-10 bg-muted/30 dark:bg-muted/50 border border-input rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all dark:text-white"
                          placeholder="••••••••"
                          required
                          disabled={loading}
                          minLength={6}
                        ...
                        <button
                          ...
                          tabIndex={-1}
                          className="absolute right-0 top-1/2 -translate-y-1/2 p-3 text-muted-foreground hover:text-foreground transition-colors"
                ...
                >
                  {loading ? "Đang xử lý..." : step === 1 ? "Xác thực mã OTP" : "Đặt Lại Mật Khẩu"}
                </button>
              </form>
...
export default function ResetPasswordPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-muted/30"><span className="text-muted-foreground">Đang tải...</span></div>}>
      <ResetPasswordForm />
    </Suspense>
  );
}
