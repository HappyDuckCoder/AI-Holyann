...
export default function RegisterPage() {
  ...
  const handleRegister = (e: React.FormEvent) => {
    ...
    // Simulate registration - in real app, this would create user account
      ...
      <div className="w-full max-w-6xl h-[600px] bg-white rounded-2xl shadow-2xl overflow-hidden flex">
        ...
        <div className="w-1/2 relative">
          ...
          <div className="absolute bottom-8 left-8 text-white">
            <h2 className="text-3xl font-bold mb-2">Holyann Explore</h2>
            <p className="text-lg opacity-90">Your Gateway to Global Education</p>
          </div>
        </div>
        ...
        <div className="w-1/2 p-12 flex flex-col justify-center">
          <div className="max-w-sm mx-auto w-full">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Tham gia để bắt đầu hành trình du học của bạn</p>
            </div>
